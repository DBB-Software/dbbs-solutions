...
class DefaultFirebaseOptions {
  ...
  static const FirebaseOptions android = FirebaseOptions(
    ...
    projectId: 'dbb-software',
    storageBucket: 'dbb-software.firebasestorage.app',
  );

  static const FirebaseOptions ios = FirebaseOptions(
    apiKey: String.fromEnvironment('FIREBASE_IOS_API_KEY',
        defaultValue: 'FIREBASE_IOS_API_KEY'),
    appId: String.fromEnvironment('FIREBASE_IOS_APP_ID',
        defaultValue: 'FIREBASE_IOS_APP_ID'),
    messagingSenderId: String.fromEnvironment(
        'FIREBASE_IOS_MESSAGING_SENDER_ID',
        defaultValue: 'FIREBASE_IOS_MESSAGING_SENDER_ID'),
    projectId: 'dbb-software',
    storageBucket: 'dbb-software.firebasestorage.app',
    iosBundleId: 'com.dbbs.flutterMobile',
  );
}
